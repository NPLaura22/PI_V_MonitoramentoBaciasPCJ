...
class BigQueryClient:
    ...
    def preparar_dataframe_ocorrencias(self, df):
        ...
        Garante que campos de texto, data, booleano, inteiro e float
        estejam nos tipos corretos — incluindo os campos de embeddings.
        """
        ...
        # Campos float gerados pelo embedding_classifier
        colunas_float = [
            "confianca_relevante",
